                    ...
                    <div class="col-md-12">
                        <div class="card" data-select2-id="9">
                            <div class="card-body" data-select2-id="8">
                                <form class="paym" method="post" id="payment_made_form" data-select2-id="7">
                                    <div class="row" data-select2-id="6">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select class="js-example-basic-single select2" name="vendor" id="vendor">
    ...
    <script type="text/javascript">
        $(document).on('change','#vendor',function()
        {
            ...
            $.ajax({
                type: 'ajax',
                method: 'post',
                url: '<?php echo base_url('admin/get_pending_bill');?>',
                data: {'vendor':vendor},
                async: false,
                dataType: 'json',
                success: function(data)
                {
                    ...
                    for(i=0; i<data.length; i++)
                    {
                        ...
                        html+='<tr class="tblro">'+
                              '<td><input class="no-outline" id="invoicedate'+i+'" name= "invoicedate'+i+'" value="'+data[i].bill_date+'"></td>'+
                              '<td><input class="no-outline" id="invoiceno'+i+'" name= "invoiceno'+i+'" value="'+data[i].bill_no+'"></td>'+
                ...
                complete: function (response)
                {
                    ...
                    else
                    {
                        ...
                        /*$('.paym,.tblro').each(function(i, obj) 
                        {
                            ...
                            $.post('<?php echo base_url('admin/save_payment_made'); ?>',{deposit:deposit,vendor:vendor,date:date,payment_mode:payment_mode,mobile:mobile,balance:balance,amount:amount,bank_charges:bank_charges,cheque_no:cheque_no,cheque_date:cheque_date,reference:reference,note:note,total:total,amount_received:amount_received,amount_used:amount_used,amount_excess:amount_excess,invoicedate:invoicedate,invoiceno:invoiceno,invoiceamount:invoiceamount,dueamount:dueamount,payment:payment},function(data)
                            {
                              //alert('aaaa'); return;
                            });
                        ...
                        $('.paym').each(function(i, obj) 
                        {
                            ...
                            $.post('<?php echo base_url('admin/save_payment_made'); ?>',{deposit:deposit,vendor:vendor,date:date,payment_mode:payment_mode,mobile:mobile,balance:balance,amount:amount,bank_charges:bank_charges,cheque_no:cheque_no,cheque_date:cheque_date,reference:reference,note:note,total:total,amount_received:amount_received,amount_used:amount_used,amount_excess:amount_excess},function(data)
                            {
                              //alert('aaaa'); return;
                            });
                        ...
                        $('.tblro').each(function(i, obj) 
                        {
                            ...
                            $.post('<?php echo base_url('admin/save_payment_made_entries'); ?>',{invoicedate:invoicedate,invoiceno:invoiceno,invoiceamount:invoiceamount,dueamount:dueamount,payment:payment},function(data)
                            {
                              //alert('aaaa'); return;
                            });
                        ...
                        {
                            //alert('success');
                            $('.success_message').show().html('<div class="alert alert-info"><strong>Payment Made Added Successfully. </strong></div>');
                            setTimeout(function()
                            {
                                window.location.href = '<?php echo base_url('admin/payment_made_list'); ?>';
                            }, 3000);
                        }
