            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="<?php echo base_url('admin/add_invoice');?>" class="btn btn-primary me-1"> <i class="fas fa-plus"></i> Add invoices </a>
                                    ...
                                    <table class="table table-stripped table-hover datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="invoice-link"><?php echo $il->invoice_no;?></a></td>
                                                ...
                                                <td class="text-end"> 
                                                    <a href="<?php echo base_url('admin/edit_invoice/'.$il->id.''); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> </a>
        ...
        $('.confirm_delete').click(function()
        {
         ...
         $('#btndelete').unbind().click(function(){
              $.ajax({
               type : 'ajax',
               method : 'post',
               url : '<?php echo base_url('admin/delete_invoice');?>',
               data : {'id':id},
               async : false,
               dataType : 'json',
               ...
               success : function(response)
               {
                 ...
                 swal('Invoice Delete SuccessFully','');
                 setTimeout(function()
                 {
