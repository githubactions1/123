...
<html lang="en">
   <head>
      ...
      <title>Report - Inventory Summary
      </title>
            ...
            <div class="content container-fluid">
               <div class="page-header">
                  <div class="row align-items-center">
                     <div class="col-lg-7">
                        <h3 class="page-title">Inventory Summary
                        ...
                        <div class="table-responsive">
                           <table class="table table-center table-hover  "  >
                              ...
                              <tbody>
                                 ...
                                 ?>
                                 <tr>
                                    <td > <a href="r-inventory-item-details.html"><?php echo $inv->name; ?></a> </td>
                                    <td class="text-end"> <?php echo (int)$inv->opening_stock + ((int)$inv->billqty - (int)$inv->invoiceqty); ?> </td>
                                    <td class="text-end"> <?php echo $inv->purchase_rate; ?> </td>
                                    <td  class="text-end">₹ 62,504.00</td>
                                 </tr>
                                 <?php } ?>
