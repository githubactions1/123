...
<html lang="en">
   <head>
      ...
      <title>Report - Account Receivable Summary Details
      </title>
            ...
            <div class="content container-fluid">
               <div class="page-header">
                  <div class="row align-items-center">
                     <div class="col-lg-7">
                        <h3 class="page-title">Account Receivable Summary Details
                        </h3>
                     </div>
                     <div class="col-lg-5">
                        <div class=" row">
                     ...
                     <div class="card card-table">
                        <div class="card-body">
                           <div class="rport">
                              ...
                              <h5>Account Receivable Summary Details
                              </h5>
                        ...
                        <div class="table-responsive">
                           <table class="table table-center table-hover  "  >
                              ...
                              <tbody>
                                 <?php
                                 foreach ($account_receivable_summary_details as $cl)
                                 {
                                 ...
                                 <tr>
                                       ...
                                       <td><a href="<?php echo base_url('admin/view_invoice/'.$cl->id.''); ?>" style="color:blue;"><?php echo $cl->invoice_no; ?></a></td>
