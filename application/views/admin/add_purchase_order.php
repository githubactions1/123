                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card invoices-add-card">
                            <div class="card-body">
                                <form class="invoices-form" method="post" id="purchase_form" action="<?php echo base_url('admin/save_purchase_order');?>" enctype="multipart/form-data" autocomplete="off">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <div class=" "> 
                                                        <span>
                                                            ...
                                                            <input class="form-control datetimepicker" type="text" name="order_date" id="order_date" placeholder="15/02/2022">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class=" ">
                                                        <span>
                                                            ...
                                                            <input class="form-control datetimepicker" type="text" name="delivery_date" id="delivery_date" placeholder="15/02/2022">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- <div class="row">
                                                ...
                                                <div class="col-lg-2 ">
                                                    <div class="form-group">
                                                        <select class="form-control" name="item_rate" id="item_rate">
                                                            <option>Item Rates Are
                                                            </option>
                                                             <option>Tax Exclusive</option>
                                                            <option>Tax Inclusive
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-center add-table-items">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="add-row">
                                                                    <td><input type="text" class="form-control" name="item_0" id="item_0" onkeyup="getitemsdetails('item_0','description_0','qty_0','rate_0','account_0','discount_0','taxrate_0');" autocomplete="off"> </td>
    ...
    <script type="text/javascript">
        $(function()
        {
            ...
            beforeSubmit: function () {
                return $("#purchase_form").valid(); // TRUE when form is valid, FALSE will cancel submit
            },
      ...
      <script type="text/javascript">
        $(document).on('change','#vendor_name',function () {
            ...
            if($(this).val() != 'none')
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url('admin/get_address_by_vendor_name');?>',
                    data: { vendor_id: vendor_id },
                    dataType: 'json',
                    success: function( response ) 
                    {
                        $('#vendor_address').val(response['billing_attention']+ ', ' +response['billing_street'] +', '+response['billing_city'] +', '+response['billing_state'] +', '+response['billing_pincode']);
