            ...
            <div class="content container-fluid">
               <div class="page-header">
                  <div class="row align-items-center">
                     <div class="col">
                        <h3 class="page-title">Company Profile List</h3>
                     </div>
                     <div class="col-auto">
                        <a href="<?php echo base_url('admin/add_company'); ?>" class="btn btn-primary me-1">
                              ...
                              <table class="table table-center table-hover datatable">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo $cl->organization_type; ?></td>
                                       <td><?php echo $cl->email; ?></td>
                                       <td><?php echo $cl->phone; ?></td>
                                       <td><?php echo $cl->status; ?></td>
                                       <td class="text-end">
                                          <a href="<?php echo base_url('admin/edit_company/'.$cl->id.''); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i></a>
             ...
             $('#btndelete').unbind().click(function(){
                  $.ajax({
                   ...
                   success : function(response)
                   {
                     ...
                     swal('Company Details Delete SuccessFully','');
                     setTimeout(function()
                     {
