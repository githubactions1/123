...
<html lang="en">
   <head>
      ...
      <title>Report - Account Payable Summary
      </title>
            ...
            <div class="content container-fluid">
               <div class="page-header">
                  <div class="row align-items-center">
                     <div class="col-lg-7">
                        <h3 class="page-title">Account Payable Summary
                        </h3>
                     </div>
                     <div class="col-lg-5">
                        <div class=" row">
                     ...
                     <div class="card card-table">
                        ...
                        <div class="table-responsive">
                           <table class="table table-center table-hover  "  >
                              ...
                              <tbody>
                                 <?php
                                 foreach ($account_payable_summary as $cl) {
                                    
                                 ?>
                                 <tr>
                                    
                                    <td><a href="<?php echo base_url('admin/account_payable_summary_details/'.$cl->id.''); ?>" style="color:blue;"><?php echo $cl->company_name; ?> </a></td>
                                    <td class="text-end">₹<?php echo $cl->opening_bal;?></td>
                                 </tr>
                                 <?php } ?>
