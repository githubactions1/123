                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card invoices-add-card">
                            <div class="card-body">
                                <form class="invoices-form" method="post" id="invoice_form" action="<?php echo base_url('admin/save_delivery_challan');?>" enctype="multipart/form-data" autocomplete="off">
                                                ...
                                                <div class="form-group">
                                                    <div class=" ">
                                                        <span>
                                                            ...
                                                            <input class="form-control datetimepicker" type="text" name="challan_date" id="challan_date" placeholder="15/02/2022">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="invoice-total-card">
                                                            ...
                                                            <div class="invoice-total-box">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6 ">
                                                                        <input class="billamt utrt1" type="text" name="sale_of_good" id="sale_of_good" onkeyup="getbillamt();" >
                                                                    </div>
                                                                </div>
      ...
      <script type="text/javascript">
        $(document).on('change','#customer_name',function () {
            ...
            if($(this).val() != 'none')
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url('admin/get_address_by_customer_name');?>',
