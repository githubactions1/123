...
<html lang="en">
   <head>
      ...
      <title>Report - Account Receivable Summary
      </title>
            ...
            <div class="content container-fluid">
               <div class="page-header">
                  <div class="row align-items-center">
                     <div class="col-lg-7">
                        <h3 class="page-title">Account Receivable Summary
                        </h3>
                     </div>
                     <div class="col-lg-5">
                        <div class=" row">
                     ...
                     <div class="card card-table">
                        ...
                        <div class="table-responsive">
                           <table class="table table-center table-hover  "  >
                              ...
                              <tbody>
                                 <?php
                                 foreach ($account_receivable_summary as $cl) {
                                    
                                 ?>
                                 <tr>
                                    
                                    <td><a href="<?php echo base_url('admin/account_receivable_summary_details/'.$cl->id.''); ?>" style="color:blue;"><?php echo $cl->name; ?> </a></td>
                                    <td><?php echo $cl->phone; ?></td>
                                    <td><?php echo $cl->work_phone; ?></td>
