            ...
            <div class="content container-fluid">
               <div class="page-header">
                  <div class="row align-items-center">
                     <div class="col-lg-7">
                        <h3 class="page-title">Bill Details
                        </h3>
                     </div>
                     <div class="col-lg-5">
                        <div class=" row">
                           ...
                           <table class="table table-center table-hover  "  >
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td><a href="<?php echo base_url('admin/view_bill/'.$il->id.''); ?>" class="invoice-link" style="color:blue;"><?php echo $il->company_name;?></a></td>
