    ...
    <div class="main-wrapper">
            ...
            <div class="content container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        ...
                        <div class="card">
                            <div class="card-body" id="purchase_order_pdf">
                                <div class="invoice-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <p class="invoice-details"> <strong style="color:#fff; background: green;padding: 5px;width: 100px;"><?php echo $edit_purchase_order->status;?> </strong> </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="invoice-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="invoice-info invoice-info2"> <strong class="customer-text">Purchase Order</strong>
                                                <!-- <p class="invoice-details"> <img src="qr.jpeg"> </p> -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="invoice-info">
                                                <p class="invoice-details invoice-details-two">
                                                <p class="invte1"> <b>Purchase Order Date: <?php echo $edit_purchase_order->order_date;?></b></p>
                                                <p class="invte1">Purchase Order No: <?php echo $edit_purchase_order->purchase_order;?></p>
                                                
                                                <p class="invte1">Source of Supply : <?php echo $edit_purchase_order->source_of_supply;?></p>
                                                <p class="invte1">Destination of Supply : <?php echo $edit_purchase_order->destination_of_supply;?></p>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="invoice-item invoice-table-wrap">
                                    <h5 style="text-align: center; padding:13px 6px 3px 0px">Purchase Order # <?php echo $edit_purchase_order->purchase_order;?> </h5>
                                    <div class="row">
                                        <div class="col-md-12">
                                                    ...
                                                    <tbody class="itemBody">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="pcs-item-row invte" style="padding: 10px 0px 10px 20px;" valign="top">
                                                                <?php echo $edit_purchase_order_entries[$i]->item; ?> <div class="pcs-item-desc" style="white-space: pre-wrap;word-wrap: break-word;"><?php echo $edit_purchase_order_entries[$i]->description; ?></div>
                                                            </td>
                                                            
                                                            <td class="pcs-item-row lineitem-column text-align-right"> <span id="tmp_item_qty"><?php echo $edit_purchase_order_entries[$i]->qty; ?></span>
                                                                <div class="pcs-item-desc">NOS</div>
                                                            </td>
                                                            <td class="pcs-item-row lineitem-column text-align-right"> <span id="tmp_item_rate"><?php echo $edit_purchase_order_entries[$i]->rate; ?></span> </td>
                                                            <td class="pcs-item-row lineitem-column text-align-right"> <span id="tmp_item_discount"><?php echo $edit_purchase_order_entries[$i]->discount; ?></span> </td>
                                                            <td class="pcs-item-row lineitem-column text-align-right"> <span id="tmp_item_tax"><?php echo $edit_purchase_order_entries[$i]->taxrate; ?>%</span> </td>
                                                            <!-- <td class="pcs-item-row lineitem-column text-align-right"> <span id="tmp_item_tax">1,174.50</span> </td>
                                                            <td class="pcs-item-row lineitem-column text-align-right"> <span id="tmp_item_tax">1,174.50</span> </td> -->
                                                            <td class="pcs-item-row lineitem-column text-align-right"> <span id="tmp_item_tax"><?php echo $edit_purchase_order_entries[$i]->taxamt; ?></span> </td>
                                                            <td class="pcs-item-row lineitem-column lineitem-content-right text-align-right"> <span id="tmp_item_amount"><?php echo $edit_purchase_order_entries[$i]->total; ?></span> </td>
                                                        </tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="invoice-total-card">
                                            <div class="invoice-total-box">
                                                <div class="invoice-total-inner">
                                                    <p style="padding: 3px;">Sub Total : <span>₹<?php echo $edit_purchase_order->subtotal; ?></span></p>
                                                    <!-- <p style="padding: 3px;">SGST @ 9.0% : <span>₹6,660.00</span></p>
                                                    <p style="padding: 3px;">CGST @ 9.0% : <span>₹3,300.00</span></p> -->
                                                    <p style="padding: 3px;">Tax Amount : <span>₹<?php echo $edit_purchase_order->total_taxamt; ?></span></p>
                                                    <p style="padding: 3px;">Adjustments <span>₹ <?php echo $edit_purchase_order->adjustment; ?> </span></p>
                                                    <p style="padding: 3px;">Total : <span>₹ <?php echo $edit_purchase_order->totalamt; ?> </span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            ...
            function generatePDF() {
                ...
                const element = document.getElementById('purchase_order_pdf');
