            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="<?php echo base_url('admin/add_delivery_challan');?>" class="btn btn-primary me-1"> <i class="fas fa-plus"></i> Add Delivery Challan </a>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-stripped table-hover datatable">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($delivery_challan_list as $il)
                                            {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo date('d-M-Y',strtotime($il->challan_date));?></td>

                                                <td><a class="invoice-link"><?php echo $il->challan_no;?></a></td>

                                                <td>
                                                    <a href="<?php echo base_url('admin/view_delivery_challan/'.$il->id.''); ?>" class="invoice-link" style="color:blue;"><?php echo $il->name;?></a>
                                                </td>
                                                ...
                                                <!-- <td>
                                                    ...
                                                    if($status == 'Sent')
                                                    {
                                                        echo '<span class="badge bg-info-light">Sent</span>';
                                                    }
                                                    if($status == 'Invoiced')
                                                    {
                                                        echo '<span class="badge bg-success-light">Invoiced</span>';
                                                    }
                                                    ?>
                                                ...
                                                <td class="text-end"> 
                                                    <a href="<?php echo base_url('admin/edit_delivery_challan/'.$il->id.''); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i> </a>
        ...
        $('.confirm_delete').click(function()
        {
         ...
         $('#btndelete').unbind().click(function(){
              $.ajax({
               type : 'ajax',
               method : 'post',
               url : '<?php echo base_url('admin/delete_delivery_challan');?>',
               data : {'id':id},
               async : false,
               dataType : 'json',
               ...
               success : function(response)
               {
                 ...
                 swal('Delivery Challan Delete SuccessFully','');
                 setTimeout(function()
                 {
