            ...
            <div class="content container-fluid">
               <div class="page-header">
                  <div class="row align-items-center">
                     ...
                     <div class="col-auto">
                        <a href="<?php echo base_url('admin/add_customer'); ?>" class="btn btn-primary me-1">
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <h2 class="table-avatar">
                                             ...
                                             <a href="<?php echo base_url('admin/view_customer/'.$cl->id.''); ?>" style="color:blue;"><?php echo $cl->name; ?> </a>
                                          </h2>
                                       </td>
                                       <!-- <td><a href="#" class="__cf_email__"  ><?php echo $cl->email; ?></a></td> -->
                                       ...
                                       <td>₹00.00</td>
                                       <td class="text-end">
                                          <a href="<?php echo base_url('admin/edit_customer/'.$cl->id.''); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i></a>
             ...
             $('#btndelete').unbind().click(function(){
                  $.ajax({
                   ...
                   success : function(response)
                   {
                     ...
                     swal('Customer Delete SuccessFully','');
                     setTimeout(function()
                     {
