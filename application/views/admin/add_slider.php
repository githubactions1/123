      ...
      <div class="col-md-12">
         <div class="card" data-select2-id="9">
            <div class="card-body" data-select2-id="8">
               <form method="post" id="slider_form" action="<?php echo base_url('admin/save_slider');?>" enctype="multipart/form-data" autocomplete="off" >
                  ...
                  <div class="row" data-select2-id="6">
                     <div class="col-md-3">
                        <div class="form-group">
                           <label>Name 1</label>
                           <div  >
                              <input class="form-control" type="text" name="slider_name1" id="slider_name1" placeholder="Slider Name 1">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                           <label>Name 2</label>
                           <div  >
                              <input class="form-control" type="text" name="slider_name2" id="slider_name2" placeholder="Slider Name 2">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                           <label>Name 3</label>
                           <div  >
                              <input class="form-control" type="text" name="slider_name3" id="slider_name3" placeholder="Slider Name 3">
                           </div>
                        </div>
                     </div>
