...
<body>
            ...
            <div class="content container-fluid">
                <div class="page-header invoices-page-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto"><a href="https://itgroups.co.in/crmphp/admin/add_customer" class="btn btn-primary me-1">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card invoices-add-card">
                            <div class="card-body">
                                <form class="invoices-form" method="post" id="invoice_form" action="<?php echo base_url('admin/save_invoice');?>" enctype="multipart/form-data" autocomplete="off">
                                                ...
                                                <div class="form-group">
                                                    <div class=" ">
                                                        <span>
                                                            ...
                                                            <input class="form-control datetimepicker" type="text" name="invoice_date" id="invoice_date" placeholder="15/02/2022">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-center add-table-items">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="add-row">
                                                                    <td><input type="text" class="form-control" name="item_0" id="item_0" onkeyup="getitemsdetails('item_0','description_0','godown_0','qty_0','rate_0','account_0','discount_0','taxrate_0');" placeholder=" "> </td>
                                                                    ...
                                                                    <td><input type="text" class="form-control"name="qty_0" id="qty_0"> </td>
                                                                    
                                                                    <td><input type="text" class="form-control" name="rate_0" id="rate_0"></td>

                                                                    <td><input type="text" class="form-control" name="account_0" id="account_0"></td>
                                                                    
                                                                    <td><input type="text" class="form-control" name="discount_0" id="discount_0"></td>
                                                        ...
                                                        <div class="invoice-total-card">
                                                            ...
                                                            <div class="invoice-total-box">
                                                                <div class="invoice-total-inner">
                                                                   <div class="" style="overflow:auto"><p> Subtotal  <span style="text-align:right"><input type="text" class="subtotal billamt form-control" name="subtotal" size="5" style="text-align: right;"></span> </div>  </p>

                                                                    <!-- <p>SGST @ 9.0% [9%] <span>₹00</span></p>
                                                                    <p>CGST @ 9.0% [9%] <span>₹00</span></p> -->

                                                                    <div class="" style="overflow:auto"><p> Tax Amt <span style="text-align:right"><input type="text" class="totaltaxamt billamt form-control" name="total_taxamt" id="total_taxamt" size="5"> </span></div>  </p>

                                                                    <div class="" style="overflow:auto"><p>Adjustments <span style="text-align:right"><input class="billamt form-control" type="text" name="adjustment" id="adjustment" onkeyup="getbillamt();" size="5"></span></div>  </p>

                                                                    <div class="" style="overflow:auto"><p>TCS on Sale Of any Goods <span style="text-align:right"><input class="billamt form-control" type="text" name="sale_of_good" id="sale_of_good" onkeyup="getbillamt();" size="5"></span></div>  </p>

                                                                    <div class="invoice-total-footer">
                                                                       <div class=""> <h4>Total Amount <span style="text-align:right"><input class="finalamt form-control" type="text" name="totalamt" size="5"></h4></div> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            
                                                            <div class="upload-sign">
                                                                <div class="form-group float-end mb-0"> <button class="btn btn-primary" type="reset">Cancle</button> </div>
                                                                <div class="form-group float-end mb-0"> <button class="btn btn-primary" type="submit" id="btn_submit" name="btn_submit">Save Invoice</button> </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        '</td>'+
        '<td>'+
        '<input type="text" class="form-control" name="qty_'+i+'" id="qty_'+i+'">'+
        '</td>'+
        '<td>'+
        '<input type="text" class="form-control" name="rate_'+i+'" id="rate_'+i+'">'+
        '</td>'+
        '<td>'+
        '<input type="text" class="form-control" name="account_'+i+'" id="account_'+i+'">'+
        '</td>'+
        '<td>'+
        '<input type="text" class="form-control" name="discount_'+i+'" id="discount_'+i+'">'+
        '</td>'+
        '<td>'+
    ...
    <script type="text/javascript">
        ...
        function subtotal()
        {
            ...
            $('.totaltaxamt').val(parseInt(sum1));

            finalamt = sum+sum1;
            $('.finalamt').val(parseInt(finalamt));
        }
