					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<form method="post" id="godown_form" action="<?php echo base_url('admin/update_godown');?>" enctype="multipart/form-data" autocomplete="off">
									<input type="hidden" name="godown_id" id="godown_id" value="<?php echo $edit_godown->id; ?>">

									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label>Name</label>
												<input type="text" name="name" id="name" class="form-control" value="<?php echo $edit_godown->name;?>">
											</div>
										</div>
