            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Payments Received</h3>
                        </div>
                        <div class="col-auto">
                            <a href="<?php echo base_url('admin/add_payment_received');?>" class="btn btn-primary me-1"> <i class="fas fa-plus"></i> Add Payments Received </a>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-center table-hover datatable">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($payment_received_list as $pr)
                                            {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url('admin/view_payment_received/'.$pr->id.''); ?>"><?php echo $pr->name; ?></a></td>
                                                <td>Payment Received</td>
                                                <td><?php echo $pr->payment_mode;?></td>
                                                <td>₹<?php if($pr->total == ''){echo '0.00';}else{echo $pr->total; } ?></td>
                                                <td>-</td>
                                                <td class="text-end">
                                                    <a href="<?php echo base_url('admin/edit_payment_received/'.$pr->id.''); ?>" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i></a>
        ...
        $('.confirm_delete').click(function()
        {
         ...
         $('#btndelete').unbind().click(function(){
              $.ajax({
               type : 'ajax',
               method : 'post',
               url : '<?php echo base_url('admin/delete_payment_received');?>',
               data : {'id':id},
               async : false,
               dataType : 'json',
               ...
               success : function(response)
               {
                 ...
                 swal('Payment Received Delete SuccessFully','');
                 setTimeout(function()
                 {
