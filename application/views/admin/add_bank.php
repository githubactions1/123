        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <form method="post" id="bank_form" action="<?php echo base_url('admin/save_bank');?>">
                                <div class=" " style="padding: 25px;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="account_code" id="account_code" class="form-control" placeholder="Account Code">
                                        </div>
                                    </div>
